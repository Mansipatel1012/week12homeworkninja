...
public class TopMenuTest extends Utility {
    ...
    public void verifyUserShouldNavigateToLaptopsAndNotebooksPageSuccessfully() throws InterruptedException {
       ...
       //Verify the text ‘Laptops & Notebooks’
        verifyText("Laptops & Notebooks",By.xpath("//h2[normalize-space()='Laptops & Notebooks']"),"Laptops & Notebooks");
    ...
    public void verifyUserShouldNavigateToComponentsPageSuccessfully() throws InterruptedException {
      ...
      //  Mouse hover on “Components” Tab and click
        ...
        verifyText("Components",By.xpath("//h2[normalize-space()='Components']"),"Components");
