...
public class LaptopAndNotebooksTest extends Utility {
    ...
    public void verifyProductsPriceDisplayHighToLowSuccessfully() throws InterruptedException {
        ...
        clikOnElement(By.xpath("//a[contains(text(),'Show AllLaptops & Notebooks')]"));
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        clikOnElement(By.xpath("//a[normalize-space()='shopping cart']"));
        ...
        //Click on “Update”Tab
        clikOnElement(By.xpath("//i[@class='fa fa-refresh']"));
        ...
        clikOnElement(By.xpath("//a[contains(text(),'Checkout')]"));
        ...
        clikOnElement(By.xpath("//input[@value='guest']"));
        //Click on “Continue” tab
        clikOnElement(By.xpath("//input[@id='button-account']"));
        ...
        clikOnElement(By.xpath("//input[@id='button-guest']"));
        ...
        //Click on “Continue” button
        clikOnElement(By.xpath("//input[@id='button-payment-method']"));
